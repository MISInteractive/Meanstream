...
Namespace Meanstream.Portal.Dynamics.Data

    Public Class ItemProvider

        Public Function GetById(Of T As {Meanstream.Portal.Dynamics.IEntity, New})(ByVal id As Guid) As T
        ...
        Public Function Find(Of T As {Meanstream.Portal.Dynamics.IEntity, New})(ByVal type As String, ByVal whereClause As String) As List(Of T)
