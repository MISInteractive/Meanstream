...
Namespace Meanstream.Portal.WordPress.Security
        ...
        ByVal providerUserKey As Object, ByRef status As MembershipCreateStatus) As MembershipUser
            ...
            Try
                ...
                Try
                    ...
                    cmd = New SqlCommand("dbo.meanstream_WordPress_CreateUser", holder.Connection)

                    cmd.CommandTimeout = CommandTimeout
                    cmd.CommandType = CommandType.StoredProcedure
                    cmd.Parameters.Add(CreateInputParam("@Id", SqlDbType.Int, 0))
                    cmd.Parameters.Add(CreateInputParam("@user_login", SqlDbType.NVarChar, username))
                    cmd.Parameters.Add(CreateInputParam("@user_pass", SqlDbType.NVarChar, pass))
                    cmd.Parameters.Add(CreateInputParam("@user_nicename", SqlDbType.NVarChar, username))
                    cmd.Parameters.Add(CreateInputParam("@user_email", SqlDbType.NVarChar, email))
                    cmd.Parameters.Add(CreateInputParam("@user_url", SqlDbType.NVarChar, ""))
                    cmd.Parameters.Add(CreateInputParam("@user_registered", SqlDbType.DateTime, dt))
                    cmd.Parameters.Add(CreateInputParam("@user_activation_key", SqlDbType.NVarChar, ""))
                    cmd.Parameters.Add(CreateInputParam("@user_status", SqlDbType.Int, 0))
                    ...
                    Dim wp_userid As Integer = cmd.Parameters("@Id").Value.ToString()
        ...
        Public Overloads Overrides Function DeleteUser(ByVal username As String, ByVal deleteAllRelatedData As Boolean) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    cmd = New SqlCommand("dbo.meanstream_WordPress_DeleteUser", holder.Connection)
                    cmd.CommandTimeout = CommandTimeout
                    cmd.CommandType = CommandType.StoredProcedure
                    cmd.Parameters.Add(CreateInputParam("@UserName", SqlDbType.NVarChar, username))
                    cmd.ExecuteNonQuery()
