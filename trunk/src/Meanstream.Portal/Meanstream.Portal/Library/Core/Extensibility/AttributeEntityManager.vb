...
Namespace Meanstream.Portal.Core.Extensibility
    ...
    Public MustInherit Class AttributeEntityManager
        ...
        Public Overridable Sub Delete()
            'delete attributes
            For Each Attribute As Attribute In Me.Attributes
        ...
        Private _OriginalAttributes As List(Of Attribute)
        Private ReadOnly Property OriginalAttributes() As List(Of Attribute)
            Get
        ...
        Private ReadOnly Property Attributes() As List(Of Attribute)
            Get
