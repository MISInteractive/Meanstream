...
#Region "Methods"
        ...
        ''' </summary>
        Public Function DefaultProvider() As RepositoryProvider
            Return [Get](0)
        End Function
        ...
        Public Function [Get](ByVal key As String) As RepositoryProvider
            Dim provider As IRepositoryProvider = ComponentFactory.GetComponent(key)
        ...
        Public Function [Get](ByVal index As Integer) As RepositoryProvider
            Dim provider As IRepositoryProvider = Nothing
            If index < 0 Then
                Return provider
            End If
...
#Region " Properties "
        ...
        ''' </summary>
        Public ReadOnly Property Providers() As IDictionary(Of String, RepositoryProvider)
            Get
                Return ComponentFactory.GetComponents(Of RepositoryProvider)()
            End Get
        End Property
        ...
        ''' </summary>
        Private _provider As RepositoryProvider
        Public Property Provider() As RepositoryProvider
            Get
                Return _provider
            End Get
            Private Set(ByVal value As RepositoryProvider)
                _provider = value
            End Set
        End Property
