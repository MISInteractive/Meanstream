...
Namespace Meanstream.Portal.Core.Services.PaymentGateway
    Public Class SubscriptionRequest
        ...
        Implements IEquatable(Of SubscriptionRequest)

        Sub New(ByVal id As String)
            MyBase.New(New Guid(id))
            _id = id
        End Sub
...
#Region " Properties "
        ...
        Private _paymentSchedule As Meanstream.Portal.Core.Services.PaymentGateway.PaymentSchedule
        Public Property PaymentSchedule() As Meanstream.Portal.Core.Services.PaymentGateway.PaymentSchedule
            Get
                Return _paymentSchedule
            End Get
            Set(ByVal value As Meanstream.Portal.Core.Services.PaymentGateway.PaymentSchedule)
...
#End Region
        ...
        Public Overloads Function Equals(ByVal other As SubscriptionRequest) As Boolean Implements System.IEquatable(Of SubscriptionRequest).Equals
