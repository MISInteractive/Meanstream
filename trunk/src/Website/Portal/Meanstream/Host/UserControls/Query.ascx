<%@ Control Language="VB" AutoEventWireup="false" CodeFile="Query.ascx.vb" Inherits="Meanstream_Host_UserControls_Query" %>
        ...
        <tr>
            <td>
                <table border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td nowrap>
                            <span class="largelink">Query</span>
                        </td>
                        <td>
                    ...
                    <td width="100%" class="nav2">
                        <div align="left">
                            ...
                            <div style="width:525px;" align="right">
                                <Meanstream:BlockUIImageButton ID="btnSave" runat="server" StartMessage="Executing Query..." Delay="300" />
                            </div>
                    </div>
                </td>
                <td width="20"><div class="spacer10x20" /></td>
