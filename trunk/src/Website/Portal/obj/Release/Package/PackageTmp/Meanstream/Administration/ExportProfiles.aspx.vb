...
Partial Class Meanstream_Core_Administration_Security_Users_ExportProfiles
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        ''Me.ProfileGrid.Columns.Add(CreateBoundColumns(New System.Data.DataColumn("Email")))
        ...
        '            Dim prof As Meanstream.Portal.Core.UserProfile = Profile.GetProfile(pi.UserName)
        ...
        Me.ProfileGrid.Columns.Add(CreateBoundColumns(New System.Data.DataColumn("Username")))
