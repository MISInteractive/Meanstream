...
(function ($) {
    $.mbMenu = {
        ...
        buildMenu: function (options) {
            return this.each(function () {
                ...
                var openOnClickSticky = this.options.openOnClickSticky;
                ...
                $(root).each(function () {
                    ...
                    */
                    if ($.metadata) {
                        ...
                        thisMenu.menuvoice = $(this).find(".rootMenu");
                    ...
                    $(thisMenu.menuvoice).each(function () {
                        $(this).addClass("rootMenu");
                        $(this).attr("nowrap", "nowrap");

                        //selected by default if set to true
                        if ($(this).attr("selected").toString().toLowerCase() == "true") {
                    ...
                    //                    //keep ImageOver image on
                    //                    $("a", thisMenu.menuvoice).mouseover(function() {
                    //                        //call mouseover method
                    //                        MM_swapImage($("a", thisMenu.menuvoice).attr("id"), '', $("a", thisMenu.menuvoice).attr("ImageOverUrl"), 1);
                    //                    });
                    //                    $("a", thisMenu.menuvoice).mouseout(function() {
                    //                        //call mouseout method
                    //                        MM_swapImgRestore();
                    ...
                    var imageOutUrl = "";
                    var imageOverUrl = "";
                    $(thisMenu.menuvoice).hover(
		                function () {
		                    imageOutUrl = $("a", this).attr("ImageUrl");
		                    imageOverUrl = $("a", this).attr("ImageOverUrl");
		                    $("img", this).attr("src", imageOverUrl);
		                },
		                function () {
		                    //$("img", this).attr("src", imageOutUrl);
		                }
	                );
    ...
    $.fn.extend({
        buildMbMenu: function (op, m, type, e) {
            ...
            var mouseOver = $.browser.msie ? "mouseenter" : "mouseover";
            var mouseOut = $.browser.msie ? "mouseleave" : "mouseout";
            var openOnClickSticky = $(op)[0].options.openOnClickSticky;
            ...
            //alerts name of the menu item onmouseover
            //alert($(this).html());
            ...
            //update to allow both div and a elements under menu container
            ...
            */
            ...
            $(this.voices).each(function (i) {
                ...
                if (!isSeparator) {
                    ...
                    //alerts name of each submenu item
                    //alert($(this).html());
                ...
                //selected by default if set to true - NOT WORKING
//                if ($(this).attr("selected").toString().toLowerCase() == "true") {
//                    $(this).addClass("selected");
//                    $(this).attr("isOpen", "true");
//                }
            ...
            if ($.browser.Chrome) {
                $(this.menuContainer).css({
                    minWidth: $(this.menuContainer).width() * 1.2
                });
            }
            //$(this.menuContainer).css("width", $(this.menuContainer).width() * 2);
            //op.options.menuWidth
            //if ($.browser.msie) $(this.menuContainer).css("width", $(this.menuContainer).width() + 2);
            //if (msie7) $(this.menuContainer).css("width", "auto");
        ...
        removeMbMenu: function (op, fade) {
            ...
            if (op.rootMenu) {
                ...
                //Add ImageURL back to img afterclose 
                $("img", op.actualOpenedMenu).attr("src", $("a", op.actualOpenedMenu).attr("ImageUrl"));
            }
        },
